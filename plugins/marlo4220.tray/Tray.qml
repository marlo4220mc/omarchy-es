...
BarWidget {
  ...
  PopupCard {
    ...
    Column {
      ...
      Text {
        text: "Los iconos fijados permanecen visibles. Los ocultos nunca se muestran."
      ...
      Text {
        visible: root.allItems.length === 0
        text: "No hay elementos en la bandeja."
      ...
      Repeater {
        ...
        delegate: Item {
          ...
          readonly property string displayName: {
            ...
            return slash !== -1 ? id.substring(slash + 1) : (id || "Desconocido")
          }
          ...
          Button {
            ...
            iconText: "\uf08d"
            text: rowRoot.isPinned ? "Desfijar" : "Fijar"
          ...
          Button {
            ...
            iconText: "\uf06e"
            text: rowRoot.isHidden ? "Mostrar" : "Ocultar"
            foreground: root.foreground
            horizontalPadding: 8
            verticalPadding: 3
            iconSize: Style.font.bodySmall
