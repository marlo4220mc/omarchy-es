...
Item {
  ...
  function openDmenu(payload) {
    ...
    dmenuPrompt = String(payload.prompt || (mode === "input" ? "Entrada" : "Selección"))
    ...
    BorderSurface {
      ...
      Item {
        ...
        ConfirmDialog {
          ...
          z: 10
          message: "¿Deseas desinstalar " + ((root.deleteTarget && root.deleteTarget.label) || "") + "?"
      ...
      Column {
        ...
        Item {
          ...
          Column {
            ...
            Text {
              textFormat: Text.PlainText
              text: root.filterText ? "Sin coincidencias para “" + root.filterText + "”" : "Aún no hay nada aquí"
              color: root.foreground
              opacity: 0.7
              font.family: root.fontFamily
