...
Panel {
  ...
  readonly property var chargingPhrases: [
    "Bombeando energía",
    "Inyectando electrones",
    "Virtiendo energía",
    "Acumulando vatios",
    "Amasando julios",
    "Sorbendo voltios",
    "Rellenando reservas",
    "Absorbiendo amperios",
    "Inhalando kilovatios"
  ]
  ...
  readonly property string heroStatusText: {
    if (fullyCharged) return "Totalmente cargada"
      ...
      Column {
        ...
        Row {
          ...
          Column {
            ...
            InfoPair { label: "Capacidad de la batería"; value: root.batteryInfo.size || "" }
            InfoPair { label: "Ciclos de carga"; value: root.batteryInfo.cycles || "—" }
          }
          ...
          Column {
            ...
            spacing: Style.spacing.labelGap
            InfoPair {
              label: root.chargeThresholdActive ? "Límite de carga" : (root.discharging ? "Tiempo restante" : "Tiempo para cargar")
              value: root.chargeThresholdActive ? (root.batteryInfo.threshold || "-") : (root.batteryFlowIdle ? "-" : (root.batteryInfo.time || "—"))
            }
            InfoPair {
              label: root.chargeThresholdActive ? "Estado de la batería" : (root.discharging ? "Descargando" : "Cargando")
              value: root.chargeThresholdActive ? "Manteniendo" : (root.batteryFull ? "-" : (root.batteryInfo.rate || ""))
            }
          }
        }
