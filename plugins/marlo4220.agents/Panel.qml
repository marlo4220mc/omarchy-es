...
Panel {
  ...
  function balanceDetailText(b) {
    ...
    var text = formatMoney(b.spent, b.currency) + " gastados de " + formatMoney(b.funded, b.currency) + " financiados"
  ...
  function footerText() {
    ...
    if (provider && provider.syncEnabled && provider.syncDeviceCount > 0)
      return "Combinado desde " + provider.syncDeviceCount + " dispositivo" + (provider.syncDeviceCount === 1 ? "" : "s")
    return ""
  }
      ...
      Flickable {
        ...
        Column {
          ...
          Text {
            ...
            text: "No se encontraron suscripciones de IA para programar.\nLos agentes aparecerán aquí una vez que los uses."
            color: root.dim
            font.family: root.fontFamily
  ...
  component LimitRow: Column {
    ...
    Text {
      ...
      text: {
        ...
        return remainingMs > 0 ? "Se reinicia en " + root.formatDuration(remainingMs) : ""
      }
      color: root.dim
      font.family: root.fontFamily
      font.pixelSize: Style.font.caption
