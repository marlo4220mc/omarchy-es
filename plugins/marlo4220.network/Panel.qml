...
Panel {
  ...
  readonly property string toggleHint: Networking.wifiEnabled ? "Apagar Wi-Fi" : "Encender Wi-Fi"
  ...
  Timer {
    ...
    onTriggered: {
      ...
      var reason
      if (root.actionKind === "connect") reason = "Tiempo agotado al conectar"
      else if (root.actionKind === "disconnect") reason = "Tiempo agotado al desconectar"
      else reason = "Tiempo agotado al olvidar"
      ...
      Item {
        ...
        RowLayout {
          ...
          Button {
            ...
            iconText: "󰓅"
            tooltipText: "Ejecutar prueba de velocidad"
            foreground: root.bar.foreground
            fontFamily: root.bar.fontFamily
            iconSize: Style.font.subtitle * 1.5
            horizontalPadding: Style.space(5)
            ...
            ToggleSwitch {
              ...
              PanelToolTip {
                ...
                text: root.bandPinned
                  ? "Deja que Wi-Fi elija la banda"
                  : "Permanecer en " + root.bandLabel(root.bandCurrent)
                fontFamily: root.bar.fontFamily
              }
            }
          }
      ...
      Column {
        ...
        Row {
          ...
          DnsProviderPill {
            provider: "Cloudflare"
            index: 1
            tooltipText: "Configurar DNS a Cloudflare"
            width: dnsRow.cellWidth
            onClicked: root.setDns(provider)
          }
          ...
          DnsProviderPill {
            provider: "Google"
            index: 2
            tooltipText: "Configurar DNS a Google"
            width: dnsRow.cellWidth
            onClicked: root.setDns(provider)
          }
          ...
          DnsProviderPill {
            provider: "Custom"
            index: 3
            tooltipText: "Configurar servidores DNS personalizados"
            width: dnsRow.cellWidth
            onClicked: root.setDns(provider)
          }
        }
  ...
  component NetworkRow: CursorSurface {
    ...
    readonly property string statusText: {
      ...
      if (isFailed) return root.failureReason || "Falló"
    ...
    Item {
      ...
      TextField {
        ...
        placeholderText: "Identidad (usuario@dominio)"
  ...
  component DetailValue: InfoValue {
    ...
    property string tooltipText: "Copiar al portapapeles"
