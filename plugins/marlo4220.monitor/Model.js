...
function brightnessName(percent) {
  ...
  if (p >= 95) return "Sol radiante"
  if (p >= 80) return "Lluvia solar"
  if (p >= 65) return "Hora dorada"
  if (p >= 45) return "Día claro"
  if (p >= 30) return "Brillo suave"
  if (p >= 20) return "Luz de lámpara"
  if (p >= 10) return "A la luz de una vela"
