...
o.bind("SUPER + SHIFT + RETURN", "Navegador", { omarchy = "browser" })
o.bind("SUPER + SHIFT + F", "Administrador de archivos", { omarchy = "nautilus" })
o.bind("SUPER + ALT + SHIFT + F", "Administrador de archivos (carpeta actual)", { omarchy = "nautilus-cwd" })
o.bind("SUPER + SHIFT + B", "Navegador", { omarchy = "browser" })
...
o.bind("SUPER + C", "Copia universal", universal_clipboard_shortcut("CTRL", "C", "CTRL", "Insert"))
o.bind("SUPER + V", "Pegado universal", universal_clipboard_shortcut("CTRL", "V", "SHIFT", "Insert"))
o.bind("SUPER + X", "Cortado universal", send_shortcut_once("CTRL", "X"))
o.bind("SUPER + CTRL + V", "Administrador del portapapeles", "omarchy-shell shell toggle omarchy.clipboard")

-- ===== tiling: ventanas, espacios de trabajo y grupos =====
o.bind("SUPER + W", "Cerrar ventana", hl.dsp.window.close())
o.bind("CTRL + ALT + DELETE", "Cerrar todas las ventanas", "omarchy-hyprland-window-close-all")

o.bind("SUPER + J", "Alternar división de ventana", hl.dsp.layout("togglesplit"))
o.bind("SUPER + P", "Ventana pseudo", hl.dsp.window.pseudo())
o.bind("SUPER + T", "Alternar ventana flotante/expandida", hl.dsp.window.float({ action = "toggle" }))
o.bind("SUPER + F", "Pantalla completa", hl.dsp.window.fullscreen({ mode = "fullscreen" }))
o.bind("SUPER + CTRL + F", "Pantalla completa en mosaico", "omarchy-hyprland-window-tiled-fullscreen-toggle")
o.bind("SUPER + ALT + F", "Ancho completo", hl.dsp.window.fullscreen({ mode = "maximized" }))
o.bind("SUPER + O", "Sacar ventana (flotar y fijar)", "omarchy-hyprland-window-pop")
...
o.bind("SUPER + LEFT", "Enfocar la ventana de la izquierda", hl.dsp.focus({ direction = "l" }))
o.bind("SUPER + RIGHT", "Enfocar la ventana de la derecha", hl.dsp.focus({ direction = "r" }))
o.bind("SUPER + UP", "Enfocar la ventana superior", hl.dsp.focus({ direction = "u" }))
o.bind("SUPER + DOWN", "Enfocar la ventana inferior", hl.dsp.focus({ direction = "d" }))

for workspace = 1, 10 do
  local key = "code:" .. tostring(workspace + 9)
  o.bind("SUPER + " .. key, "Cambiar al espacio de trabajo " .. workspace, hl.dsp.focus({ workspace = tostring(workspace) }))
  o.bind("SUPER + SHIFT + " .. key, "Mover ventana al espacio de trabajo " .. workspace, hl.dsp.window.move({ workspace = tostring(workspace) }))
  o.bind("SUPER + SHIFT + ALT + " .. key, "Mover ventana en silencio al espacio de trabajo " .. workspace, hl.dsp.window.move({ workspace = tostring(workspace), follow = false }))
end

o.bind("SUPER + S", "Alternar anotador (scratchpad)", hl.dsp.workspace.toggle_special("scratchpad"))
o.bind("SUPER + ALT + S", "Mover ventana al anotador (scratchpad)", hl.dsp.window.move({ workspace = "special:scratchpad", follow = false }))

o.bind("SUPER + TAB", "Siguiente espacio de trabajo", hl.dsp.focus({ workspace = "e+1" }))
o.bind("SUPER + SHIFT + TAB", "Anterior espacio de trabajo", hl.dsp.focus({ workspace = "e-1" }))
o.bind("SUPER + CTRL + TAB", "Anterior espacio de trabajo", hl.dsp.focus({ workspace = "previous" }))
...
o.bind("SUPER + SHIFT + LEFT", "Intercambiar ventana a la izquierda", hl.dsp.window.swap({ direction = "l" }))
o.bind("SUPER + SHIFT + RIGHT", "Intercambiar ventana a la derecha", hl.dsp.window.swap({ direction = "r" }))
o.bind("SUPER + SHIFT + UP", "Intercambiar ventana hacia arriba", hl.dsp.window.swap({ direction = "u" }))
o.bind("SUPER + SHIFT + DOWN", "Intercambiar ventana hacia abajo", hl.dsp.window.swap({ direction = "d" }))

o.bind("ALT + TAB", "Enfocar la siguiente ventana", hl.dsp.window.cycle_next())
o.bind("ALT + SHIFT + TAB", "Enfocar la ventana anterior", hl.dsp.window.cycle_next({ next = false }))
o.bind("ALT + TAB", "Presentar la ventana activa en primer plano", hl.dsp.window.bring_to_top())
o.bind("ALT + SHIFT + TAB", "Presentar la ventana activa en primer plano", hl.dsp.window.bring_to_top())

o.bind("CTRL + ALT + TAB", "Enfocar el siguiente monitor", hl.dsp.focus({ monitor = "+1" }))
o.bind("CTRL + ALT + SHIFT + TAB", "Enfocar el monitor anterior", hl.dsp.focus({ monitor = "-1" }))

o.bind("SUPER + code:20", "Expandir ventana a la izquierda", hl.dsp.window.resize({ x = -100, y = 0, relative = true }))
o.bind("SUPER + code:21", "Contraer ventana a la izquierda", hl.dsp.window.resize({ x = 100, y = 0, relative = true }))
o.bind("SUPER + SHIFT + code:20", "Contraer ventana hacia arriba", hl.dsp.window.resize({ x = 0, y = -100, relative = true }))
o.bind("SUPER + SHIFT + code:21", "Expandir ventana hacia abajo", hl.dsp.window.resize({ x = 0, y = 100, relative = true }))

o.bind("SUPER + ALT + code:20", "Expandir ventana un poco a la izquierda", hl.dsp.window.resize({ x = -25, y = 0, relative = true }))
o.bind("SUPER + ALT + code:21", "Contraer ventana un poco a la izquierda", hl.dsp.window.resize({ x = 25, y = 0, relative = true }))
o.bind("SUPER + SHIFT + ALT + code:20", "Contraer ventana un poco hacia arriba", hl.dsp.window.resize({ x = 0, y = -25, relative = true }))
o.bind("SUPER + SHIFT + ALT + code:21", "Expandir ventana un poco hacia abajo", hl.dsp.window.resize({ x = 0, y = 25, relative = true }))

o.bind("SUPER + CTRL + code:20", "Expandir ventana mucho a la izquierda", hl.dsp.window.resize({ x = -300, y = 0, relative = true }))
o.bind("SUPER + CTRL + code:21", "Contraer ventana mucho a la izquierda", hl.dsp.window.resize({ x = 300, y = 0, relative = true }))
o.bind("SUPER + CTRL + SHIFT + code:20", "Contraer ventana mucho hacia arriba", hl.dsp.window.resize({ x = 0, y = -300, relative = true }))
o.bind("SUPER + CTRL + SHIFT + code:21", "Expandir ventana mucho hacia abajo", hl.dsp.window.resize({ x = 0, y = 300, relative = true }))

o.bind("SUPER + mouse_down", "Desplazar el espacio activo hacia adelante", hl.dsp.focus({ workspace = "e+1" }))
o.bind("SUPER + mouse_up", "Desplazar el espacio activo hacia atrás", hl.dsp.focus({ workspace = "e-1" }))

o.bind("SUPER + mouse:272", "Mover ventana", hl.dsp.window.drag(), { mouse = true })
o.bind("SUPER + mouse:273", "Redimensionar ventana", hl.dsp.window.resize(), { mouse = true })

o.bind("SUPER + G", "Alternar agrupación de ventanas", hl.dsp.group.toggle())
o.bind("SUPER + ALT + G", "Sacar la ventana activa del grupo", hl.dsp.window.move({ out_of_group = true }))

o.bind("SUPER + ALT + LEFT", "Mover ventana al grupo de la izquierda", hl.dsp.window.move({ into_group = "l" }))
o.bind("SUPER + ALT + RIGHT", "Mover ventana al grupo de la derecha", hl.dsp.window.move({ into_group = "r" }))
o.bind("SUPER + ALT + UP", "Mover ventana al grupo superior", hl.dsp.window.move({ into_group = "u" }))
o.bind("SUPER + ALT + DOWN", "Mover ventana al grupo inferior", hl.dsp.window.move({ into_group = "d" }))

o.bind("SUPER + ALT + TAB", "Siguiente ventana del grupo", hl.dsp.group.next())
o.bind("SUPER + ALT + SHIFT + TAB", "Ventana anterior del grupo", hl.dsp.group.prev())

o.bind("SUPER + CTRL + LEFT", "Mover el enfoque del grupo a la izquierda", hl.dsp.group.prev())
o.bind("SUPER + CTRL + RIGHT", "Mover el enfoque del grupo a la derecha", hl.dsp.group.next())

o.bind("SUPER + ALT + mouse_down", "Siguiente ventana del grupo", hl.dsp.group.next())
o.bind("SUPER + ALT + mouse_up", "Ventana anterior del grupo", hl.dsp.group.prev())

for index = 1, 5 do
  o.bind("SUPER + ALT + code:" .. tostring(index + 9), "Cambiar a la ventana " .. index .. " del grupo", hl.dsp.group.active({ index = index }))
end
...
-- ===== utilidades y menús =====
o.bind("SUPER + SPACE", "Menú de Omarchy", "omarchy-menu toggle")
...
o.bind("SUPER + SHIFT + code:201", "Menú de Omarchy", "omarchy-menu toggle root")
o.bind("SUPER + ESCAPE", "Menú de sistema", "omarchy-menu toggle system")
o.bind("XF86PowerOff", "Menú de energía", "omarchy-menu toggle system", { locked = true })
o.bind("SUPER + K", "Atajos de teclado", "omarchy-menu-keybindings")
o.bind("SUPER + ALT + K", "Atajos de Tmux", "omarchy-menu-tmux-keybindings")
o.bind("SUPER + CTRL + K", "Atajos de Herdr", "omarchy-menu-herdr-keybindings")
...
o.bind("SUPER + SHIFT + CTRL + SPACE", "Menú de temas", "omarchy-menu toggle theme")
o.bind("SUPER + BACKSPACE", "Alternar transparencia de ventana", "omarchy-hyprland-window-transparency-toggle")
...
o.bind("SUPER + comma", "Descartar la última notificación", "omarchy-shell notifications dismissOne")
o.bind("SUPER + SHIFT + comma", "Descartar todas las notificaciones", "omarchy-shell notifications dismissAll")
o.bind_toggle("SUPER + CTRL + comma", "Alternar silencio de notificaciones", "notification-silencing")
o.bind("SUPER + ALT + comma", "Invocar la última notificación", "omarchy-shell notifications invokeLast")
o.bind("SUPER + SHIFT + ALT + comma", "Abrir histórico de notificaciones", "omarchy-shell notifications showHistory")

o.bind_toggle("SUPER + CTRL + I", "Alternar bloqueo al reposo", "idle")
o.bind_toggle("SUPER + CTRL + N", "Alternar luz nocturna", "nightlight")
...
o.bind("PRINT", "Captura de pantalla", "omarchy-capture-screenshot")
o.bind("ALT + PRINT", "Grabación de pantalla", "omarchy-capture-screenrecording --stop-recording || omarchy-menu toggle trigger.capture.screenrecord")
...
o.bind("SUPER + PRINT", "Selector de color", "pkill hyprpicker || hyprpicker -a")
...
o.bind("SUPER + CTRL + L", "Bloquear sistema", "omarchy-system-lock")
